...
class PVTransformer(TransformerMixin):
    ...
    def __init__(self, size=16, window=8, min_count=1, workers=1, alpha=0.025, dm=1, epochs=2, random_seed=None):
    ...
    def fit(self, X, y=None):
        ...
        for epoch in range(self.epochs):
            ...
            print(train_documents)
            self.pv_model.train(train_documents,total_examples=self.min_count, epochs=self.epochs)
